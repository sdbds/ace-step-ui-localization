...
export const translations = {
  en: {
    ...
    opusEfficient: 'Opus (efficient)',
    aacUniversal: 'AAC (universal)',
    wav16Bit: 'WAV (16-bit)',
    wav32Float: 'WAV (32-bit float)',
    ...
    repaintModeTooltip: 'Choose how strongly repaint regenerates the selected region.',
    repaintStrengthTooltip: '0 = conservative, 1 = aggressive. Used in balanced mode.',
    repaintModeHelp: 'Conservative preserves more source audio, aggressive regenerates more.',
    repaintStrengthHelp: 'Balanced mode only.',
    repaintModeConservative: 'Conservative',
    repaintModeBalanced: 'Balanced',
    repaintModeAggressive: 'Aggressive',
  ...
  zh: {
    ...
    opusEfficient: 'Opus（高压缩）',
    aacUniversal: 'AAC（通用）',
    wav16Bit: 'WAV（16 位）',
    wav32Float: 'WAV（32 位浮点）',
    ...
    repaintModeTooltip: '选择对选中区域的重绘激进程度。',
    repaintStrengthTooltip: '0 = 更保守，1 = 更激进。仅在平衡模式下生效。',
    repaintModeHelp: '保守模式保留更多源音频，激进模式重生成更多内容。',
    repaintStrengthHelp: '仅平衡模式可调。',
    repaintModeConservative: '保守',
    repaintModeBalanced: '平衡',
    repaintModeAggressive: '激进',
  ...
  ja: {
    ...
    repaintMode: 'リペイントモード',
    repaintStrength: 'リペイント強度',
    ...
    opusEfficient: 'Opus（高圧縮）',
    aacUniversal: 'AAC（汎用）',
    wav16Bit: 'WAV（16ビット）',
    wav32Float: 'WAV（32ビット浮動小数点）',
    ...
    repaintModeTooltip: '選択した領域をどの程度強くリペイントするかを選びます。',
    repaintStrengthTooltip: '0 = 保守的、1 = 積極的。バランスモードでのみ使用されます。',
    repaintModeHelp: '保守的は元音声をより多く保持し、積極的はより多く再生成します。',
    repaintStrengthHelp: 'バランスモードでのみ調整可能です。',
    repaintModeConservative: '保守的',
    repaintModeBalanced: 'バランス',
    repaintModeAggressive: '積極的',
  ...
  ko: {
    ...
    opusEfficient: 'Opus (고압축)',
    aacUniversal: 'AAC (범용)',
    wav16Bit: 'WAV (16비트)',
    wav32Float: 'WAV (32비트 부동소수점)',
    ...
    repaintModeTooltip: '선택한 구간을 얼마나 강하게 리페인트할지 선택합니다.',
    repaintStrengthTooltip: '0 = 더 보수적, 1 = 더 공격적. 균형 모드에서만 사용됩니다.',
    repaintModeHelp: '보수적 모드는 원본 오디오를 더 많이 유지하고, 공격적 모드는 더 많이 재생성합니다.',
    repaintStrengthHelp: '균형 모드에서만 조절할 수 있습니다.',
    repaintModeConservative: '보수적',
    repaintModeBalanced: '균형',
    repaintModeAggressive: '공격적',
